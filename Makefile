...
ARCH = -m64
CPPSTD = c++17
CFLAGS = -Wall -Wextra -fno-diagnostics-show-option $(ARCH) -std=$(CPPSTD) -I . -I/usr/include/lua5.1 -Idep/include -Isrc -Idependencies -Idependencies/brando/include -pg
LFLAGS = $(ARCH) -pg
...
LIBS = -L/usr/lib64 -L/usr/local/lib64 -L/usr/lib -L/usr/local/lib -L/usr/lib/x86_64-linux-gnu/mesa -Ldep/lib $(PLATFORM_LIBS) -lGLESv2 -lEGL -llua-5.3 -lm -lX11 -lpthread -ldl
EXECUTABLE = vitae
include Makelist
