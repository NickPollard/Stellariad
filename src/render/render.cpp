...
void render_init( void* app ) {
	...
	renderPass_depth.alpha(false).color(false).depth(true).test(true).clear(true);
...
void render_drawShaderBatch( window* w, int count, const drawCall* calls ) {
