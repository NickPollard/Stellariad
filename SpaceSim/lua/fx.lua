...
function fx.spawn_explosion( position )
	local t = vcreateTransform()
	local explosion = vparticle_create( engine, t, "dat/script/lisp/explosion.s" )
	local explosion_b = vparticle_create( engine, t, "dat/script/lisp/explosion_b.s" )
	local explosion_c = vparticle_create( engine, t, "dat/script/lisp/explosion_c.s" )
	vtransform_setWorldSpaceByTransform( t, position )
	inTime( 5.0, function () 
		vdestroyTransform( scene, t ) 
		vparticle_destroy( explosion )
